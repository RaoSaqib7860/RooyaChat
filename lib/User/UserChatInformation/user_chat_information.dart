...
class UserChatInformation extends StatefulWidget {
  ...
  const UserChatInformation({Key? key, this.groupID}) : super(key: key);
...
class _UserChatInformationState extends State<UserChatInformation> {
  ...
  @override
  void initState() {
    infoController.getGroupInfo(groupID: widget.groupID);
    super.initState();
  }
                        ...
                        : CustomScrollView(slivers: [
                            SliverAppBar(
                              ...
                              flexibleSpace: FlexibleSpaceBar(
                                title: Text(
                                  '  ${infoController.infoModel.value.groupName}                                   ',
                                  style: TextStyle(
                                      fontSize: 18,
                                  ...
                                  Row(
                                    children: [
                                      Padding(
                                        ...
                                        child: Text(
                                          '${infoController.infoModel.value.groupDecs.toString().trim().isEmpty ? 'Description' : infoController.infoModel.value.groupDecs}',
                                          style: TextStyle(
                                            fontSize: 13,
                                            fontFamily: AppFonts.segoeui,
                                          ),
                              ...
                              return Column(
                                children: [
                                  ListTile(
                                    ...
                                    //       fontSize: 12),
                                    // ),
                                    trailing: infoController.infoModel.value
