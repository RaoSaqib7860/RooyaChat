                                ...
                                return FocusedMenuHolder(
                                                                ...
                                                                extension.contains('.jpg') ||
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Align(
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Text(
                                                                                    '${DateTime.parse("${getcontroller!.oneToOneChat[i].message!.iosDateTime}").day} ${DateFormat.yMMM().format(DateTime.parse("${getcontroller!.oneToOneChat[i].message!.iosDateTime}")).toString().split(' ')[0]} , ${sdf2.format(DateTime.parse("${getcontroller!.oneToOneChat[i].message!.iosDateTime}").toUtc().toLocal())}',
                                                                                    style: TextStyle(
                                                                    ...
                                                                    : extension.contains('.mp4') ||
                                                                        ...
                                                                        : extension.contains('.mp3') ||
                                                                                ...
                                                                                extension.contains('.ac3') ||
                                                                                extension.contains('.h264') ||
                                                                                extension.contains('.wav') ||
                                                                                extension.contains('.csv') ||
                                                                                extension.contains('.wma') ||
                                                                                ...
                                                                                : Container(
                                                                                    ...
                                                                                    child: Column(
                                                                                      children: [
                                                                                        Text(
                                                                                          '${getcontroller!.oneToOneChat[i].message!.message}',
                                                                                          style: TextStyle(color: Colors.black, fontWeight: FontWeight.w300, fontSize: 13),
                                                                                        ),
                                                                                        SizedBox(
                                                                                          height: height / 100,
                                                                                        ),
                                  ...
                                  menuItems: <FocusedMenuItem>[
                                    ...
                                    FocusedMenuItem(
                                        title: Text("Reply"),
                                        onPressed: () {},
                                        trailingIcon: Icon(CupertinoIcons.reply,
                                            size: 20)),
                                    FocusedMenuItem(
                                        title: Text("Forward"),
                                        onPressed: () {},
                            ...
                            child: TextFormField(
                              ...
                              onChanged: (value) {
                                if (!getcontroller!.startTyping.value) {
                                  ...
                                  getcontroller!
                                      .userTypingStart(groupId: widget.groupID);
                                }
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                        onTap: () async {
                                          ...
                                          getcontroller!.recording_start.value =
                                              false;
                                          Future.delayed(
                                        ...
                                        onLongPress: () async {
                                          bool result = await record.Record()
                                              .hasPermission();
